...
*Documentation below refers to latest API version, available in branch [v3.0.0](https://github.com/aherne/oauth2client/tree/v3.0.0)! For older version in master branch, check [Lucinda Framework](https://www.lucinda-framework.com/oauth2-client).*
